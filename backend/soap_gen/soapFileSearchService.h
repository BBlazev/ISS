...
#ifndef soapFileSearchService_H
#define soapFileSearchService_H
#include "soapH.h"

    class SOAP_CMAC FileSearchService {
      public:
        ...
        bool soap_own;
        /// Variables globally declared in backend/soap/file_search.h, if any
        /// Construct a service with new managing context
        FileSearchService();
        /// Copy constructor
        FileSearchService(const FileSearchService&);
        /// Construct service given a shared managing context
        FileSearchService(struct soap*);
        /// Constructor taking input+output mode flags for the new managing context
        FileSearchService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        FileSearchService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and its managing context, when the context was allocated by the constructor
        virtual ~FileSearchService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void FileSearchService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual FileSearchService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        FileSearchService& operator=(const FileSearchService&);
        ...
        //
        /// Web service operation 'searchFiles' implementation, should return SOAP_OK or error code
        virtual int searchFiles(const std::string& term, std::vector<fs__FileResult> &result) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'hello' implementation, should return SOAP_OK or error code
        virtual int hello(std::string &result) SOAP_PURE_VIRTUAL;
    };
#endif
